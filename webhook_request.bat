@echo off
REM This is a Windows batch script that sends a POST request to a webhook endpoint
...
REM Assign the id argument to a variable
set id=%~1

REM Execute the curl command with the provided id
curl --request POST ^
  --url https://giraffe-legible-centrally.ngrok-free.app/webhook ^
  ...
  \"event\": {
    ...
    \"id\": \"3592c237-e72b-4e71-8de2-569dcf0b515f\",
    \"resource\": \"event\",
